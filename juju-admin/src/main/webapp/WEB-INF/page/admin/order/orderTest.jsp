...
Ext.onReady(function() {
    ...
    /* App.store.user.userAccountNameAndId = Ext.create('Ext.data.Store', {
    	fields : ['Key' , 'value'],
    	pageSize : 20,
    	proxy : {
    		type : 'ajax',
    		url : '${contextPath}/user/getUserAccountIdByNmae.do',
    		reader : {
    			type : 'json',
    			root : 'results',
    			successProperty : 'success',
    ...
    var orderStore = Ext.create('Ext.data.ArrayStore', {
        fields : ['id', 'orderNo', 'telephone', 'orderTotal', 'orderStatus', 'orderStatusName', 'userAcountIdName',
                  'paymentStatus', 'paymentStatusName', 'userAccountId', 'ownerAccountId', 'orderTime', 'createTime', 'lastUpdateTime', 'stat'
